...
export default function Store() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      {/* Search, Filters & Categories - Fixed below header */}
      <div className="sticky top-[57px] sm:top-[65px] z-40 bg-background/80 backdrop-blur-xl border-b border-border/30">
