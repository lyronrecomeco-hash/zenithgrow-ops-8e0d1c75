    ...
    <div className="flex flex-col h-full bg-sidebar">
      <div className="p-5 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-semibold text-sm text-foreground">Store Manager</h1>
            <p className="text-[11px] text-muted-foreground">Sistema ERP</p>
          </div>
        </div>
      </div>
...
export function AppSidebar() {
    ...
    return (
      <>
        <Button
          variant="ghost"
          size="icon"
          className="fixed top-3 left-3 z-50 h-10 w-10 bg-card border border-border shadow-lg"
  ...
  return (
    <aside className="w-[260px] shrink-0 hidden md:block h-screen sticky top-0 border-r border-sidebar-border">
      <SidebarNav />
    </aside>
  );
}
